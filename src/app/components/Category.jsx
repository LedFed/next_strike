...
export default function Category() {
    const catalog = [
        ...
        { title: 'Растяжки-мины', active: true, links: './icons/free-icon-grenade-13091752.svg', chapter:"Раздел страйкбольных мин и растяжек" },
        { title: 'Пульты', active: true, links: './icons/free-icon-remote-16276269.svg', chapter:"Раздел пультов для дистанционного запуска гранат, дымов и растяжек" },
